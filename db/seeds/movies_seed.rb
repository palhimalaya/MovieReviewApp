...
movie1.cover_img.attach(io: File.open(Rails.root.join('app/assets/images/shawshank.png')), filename: 'cover_image.png')
movie2.cover_img.attach(io: File.open(Rails.root.join('app/assets/images/inception.png')), filename: 'cover_image.png')
